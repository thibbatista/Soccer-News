package com.thiagosantos.soccernews.data;


import com.thiagosantos.soccernews.App;
import com.thiagosantos.soccernews.data.local.SoccerNewsDb;
import com.thiagosantos.soccernews.data.remote.SoccerNewsApi;
...
public class SoccerNewsRepository {
    ...
    //region Constantes
    private static final String REMOTE_API_URL = "https://thibbatista.github.io/soccer-news-api/";
